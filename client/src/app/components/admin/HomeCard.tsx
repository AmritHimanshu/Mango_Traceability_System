...
function HomeCard({ title, description, count, textColor }: HomeCardProps) {
  ...
  return (
    <div className={`p-3 md:p-5 text-[13px] md:text-[16px] font-bold bg-cardBackground w-[250px] xl:w-[250px] 2xl:w-[300px] h-[250px] xl:h-[250px] 2xl:h-[300px] rounded-full shadow-md flex flex-col items-center justify-center ${textColorClass}`}>
      <p>{title}</p>
