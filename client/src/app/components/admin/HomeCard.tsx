...
function HomeCard({ title, description, count, textColor }: HomeCardProps) {
  ...
  return (
    <div className={`p-3 md:p-5 space-y-1 lg:space-y-2 text-[13px] md:text-[16px] text-center font-bold bg-gray0 shadow-xl w-[250px] xl:w-[250px] 2xl:w-[300px] h-[250px] xl:h-[250px] 2xl:h-[300px] rounded-full flex flex-col items-center justify-center ${textColorClass} hover:bg-sky-100 hover:bg-gradient-to-t hover:from-sky-100 hover:to-white duration-1000 overflow-hidden`}>
      <p>{title}</p>
