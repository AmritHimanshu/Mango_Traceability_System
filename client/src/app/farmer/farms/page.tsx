    ...
    <div className="page-main-div">
      ...
      <div className="h-[500px] md:h-[600px] xl:h-[400px] relative">
        ...
        <div className="p-3 md:p-5 absolute top-0 w-full h-full bg-neutral-950 bg-opacity-50 flex items-center justify-center">
          <div className="">
            <button
              className="!w-[170px] lg:!w-[220px] text-button-size bg-customOrange bg-opacity-90 text-white font-bold rounded-md hover:shadow-md hover:bg-opacity-95 duration-200"
